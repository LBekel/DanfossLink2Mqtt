"""Configuration for DanfossLink2Mqtt loaded from the central config.yaml."""
...
def _load_settings() -> Dict[str, Any]:
    """Load settings from the central config.yaml."""
...
# App configuration
# Package name is fixed and no longer read from YAML.
